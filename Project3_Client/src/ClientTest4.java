...
//		c.addFrontEnd(host2, port2);
	...
	public void test01_correctPost() {
		logger.info("Test correct post10.");
		String body = "{\"text\":\"correct Post 10 #ht\"}";
		String content = "POST /tweets HTTP/1.1\r\nContent-Length:"
				+ body.length()
				+ "\r\nContent-Type: application/json;charset=utf-8\r\n\r\n"
				+ body;
		HTTPResponseContent response = c.sendRequest(content);
		logger.info("Response from correct post10: \n{}.",
	...
	public void test02_correctPost2() {
		logger.info("Test correct post11.");
		String body = "{\"text\":\"correct Post 11 #ht #ts\"}";
		String content = "POST /tweets HTTP/1.1\r\nContent-Length:"
				+ body.length()
				+ "\r\nContent-Type: application/json;charset=utf-8\r\n\r\n"
				+ body;
		HTTPResponseContent response = c.sendRequest(content);
		logger.info("Response from correct post11: \n{}.",
				response.getResponseString());
		Assert.assertEquals(response, HTTPResponse.response_201());
	}
	...
	public void test03_correctPost3() {
		logger.info("Test correct post12.");
		String body = "{\"text\":\"correct Post 12 #hta #tsa\"}";
		String content = "POST /tweets HTTP/1.1\r\nContent-Length:"
				+ body.length()
				+ "\r\nContent-Type: application/json;charset=utf-8\r\n\r\n"
				+ body;
		HTTPResponseContent response = c.sendRequest(content);
		logger.info("Response from correct post12: \n{}.",
				response.getResponseString());
		Assert.assertEquals(response, HTTPResponse.response_201());
	}
