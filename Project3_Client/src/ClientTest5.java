...
//		c.addFrontEnd(host2, port2);
	...
	public void test01_correctPost() {
		logger.info("Test correct post13.");
		String body = "{\"text\":\"correct Post 13 #ht\"}";
		String content = "POST /tweets HTTP/1.1\r\nContent-Length:"
				+ body.length()
				+ "\r\nContent-Type: application/json;charset=utf-8\r\n\r\n"
				+ body;
		HTTPResponseContent response = c.sendRequest(content);
		logger.info("Response from correct post13: \n{}.",
	...
	public void test02_correctPost2() {
		logger.info("Test correct post14.");
		String body = "{\"text\":\"correct Post 14 #ht #ts\"}";
		String content = "POST /tweets HTTP/1.1\r\nContent-Length:"
				+ body.length()
				+ "\r\nContent-Type: application/json;charset=utf-8\r\n\r\n"
				+ body;
		HTTPResponseContent response = c.sendRequest(content);
		logger.info("Response from correct post14: \n{}.",
				response.getResponseString());
		Assert.assertEquals(response, HTTPResponse.response_201());
	}
	...
	public void test03_correctPost3() {
		logger.info("Test correct post15.");
		String body = "{\"text\":\"correct Post 15 #hta #tsa\"}";
		String content = "POST /tweets HTTP/1.1\r\nContent-Length:"
				+ body.length()
				+ "\r\nContent-Type: application/json;charset=utf-8\r\n\r\n"
				+ body;
		HTTPResponseContent response = c.sendRequest(content);
		logger.info("Response from correct post15: \n{}.",
				response.getResponseString());
		Assert.assertEquals(response, HTTPResponse.response_201());
	}
