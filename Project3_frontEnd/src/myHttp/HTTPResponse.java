...
public class HTTPResponse {
  ...
  public static HTTPResponseContent response_503() {
    HTTPResponseContent response_503 = new HTTPResponseContent();
    response_503.setResponseBody("");
    response_503.setResponseHeader(new HTTPResponseHeader("HTTP/1.1 503 Service Unavailable", response_503.getResponseBody().length()));
    return response_503;
  }
